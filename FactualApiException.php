...
class FactualApiException extends Exception {
	...
	public function __construct($info) {
		...
		$this->message .= " Use Factual::debug() to echo detailed debug info to stdout, " .
				"or use FactualApiException::debug() to obtain debug information " .
				"programatically. See ". $this->helpUrl. " for information on " .
				"debug mode, submitting issues, and figuring out, generally, WTF is going on";
	}
